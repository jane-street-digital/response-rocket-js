...
`;let b="https://responserocket.app/api/increment";const l=document.querySelector("script[site_key]"),p=l.getAttribute("site_key"),n=document.body.classList.contains("darkMode")||l.getAttribute("darkMode"),i=document.getElementsByClassName("response-rocket");if(i.length){for(let e=0;e<i.length;e++)i[e].innerHTML=`
