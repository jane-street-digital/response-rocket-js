...
`;let l="https://responserocket.test/api/increment";process.env.NODE_ENV==="production"&&(l="https://responserocket.app/api/increment");const p=document.querySelector("script[site_key]"),h=p.getAttribute("site_key"),n=document.body.classList.contains("darkMode")||p.getAttribute("darkMode"),i=document.getElementsByClassName("response-rocket");if(i.length){for(let e=0;e<i.length;e++)i[e].innerHTML=`
      ...
      `;const s=document.getElementsByClassName("response-rocket-button");let o=!1;for(let e=0;e<s.length;e++)s[e].addEventListener("click",function(){const{hash:r,pathname:c}=window.location;o||fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},mode:"cors",body:JSON.stringify({siteKey:h,hash:r,pathname:c})}).then(t=>t.json()).then(t=>{o=t.exceededClickLimit,t.reactions&&(this.getElementsByTagName("span")[0].innerHTML=t.reactions)}).catch(t=>console.error(t))});u(h)}});
