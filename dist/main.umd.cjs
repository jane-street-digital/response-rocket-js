(function(l){typeof define=="function"&&define.amd?define(l):l()})(function(){"use strict";const l="";function d(o,c){const a=new URLSearchParams({pathname:window.location.pathname,siteKey:o});fetch(`${c}?${a}`).then(t=>t.json()).then(t=>{const i=document.getElementsByClassName("response-rocket-count");for(let r=0;r<i.length;r++)t.reactions>0&&(i[r].innerHTML=t.reactions)}).catch(t=>console.error(t))}const m=`
