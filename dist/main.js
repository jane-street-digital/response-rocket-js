...
</svg>`, p = "https://responserocket.app/api/increment", a = document.querySelector("script[site_key]"), c = a.getAttribute("site_key"), h = document.body.classList.contains("darkMode") || a.getAttribute("darkMode"), s = document.querySelector(".response-rocket");
if (s.length) {
