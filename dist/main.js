...
`, i = document.querySelector("script[site_key]"), p = i.getAttribute("site_key"), a = document.body.classList.contains("darkMode") || i.getAttribute("darkMode"), l = document.getElementsByClassName("response-rocket");
let h = "https://responserocket.app/api/increment";
i.getAttribute("dev") && (h = "https://responserocket.test/api/increment");
if (l.length) {
  ...
  i.getAttribute("dev") && (o = "https://responserocket.test/api/page"), m(p, o);
}
