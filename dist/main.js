function i(o) {
  ...
  fetch(`https://responserocket.app/api/page?${e}`).then((n) => n.json()).then((n) => {
...
</svg>`, p = "https://responserocket.app/api/increment", a = document.querySelector("script[site_key]"), c = a.getAttribute("site_key"), m = document.body.classList.contains("darkMode") || a.getAttribute("darkMode"), s = document.getElementsByClassName("response-rocket");
if (s.length) {
